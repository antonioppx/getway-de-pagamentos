        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="text-center">
            ...
            <div className="mt-2 text-xs text-gray-500 space-y-1">
              <p><strong>Admin:</strong> admin@pagamentos.com / admin123</p>
              <p><strong>User:</strong> user@pagamentos.com / user123</p>
              <p><strong>Merchant:</strong> merchant@pagamentos.com / merchant123</p>
            </div>
          </div>
        </form>
      </div>
